...
<body>
	...
	<form action="booking_delete" method="post">
		<label for="cid">Booking ID</label><br>
		<input type="text" name="ID" class="form-control bg-light border-0" value="<%= id%>" readonly><br><br>
		<label for="name">Name</label><br>
		<input type="text" name="NAME" class="form-control bg-light border-0"  value="<%= name%>" readonly><br><br>
		<label for="password">Nic number</label><br>
		<input type="password" name="NIC" class="form-control bg-light border-0"  value="<%= nic%>" readonly><br><br>
		<label for="phone">Booking Type</label><br>
		<input type="text" name="TYPE" class="form-control bg-light border-0"  value="<%= type%>" readonly><br><br>
		<label for="email">Booking Date</label><br>
		<input type="text" name="DATE" class="form-control bg-light border-0"  value="<%= date%>" readonly><br><br>
		<label for="email">Vacancies ID</label><br>
		<input type="text" name="V_ID" class="form-control bg-light border-0"  value="<%= vid%>" readonly><br><br>
