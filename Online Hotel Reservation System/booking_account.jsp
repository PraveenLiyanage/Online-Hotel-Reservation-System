...
<body>
            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">booking account </h1>	
	...
	<c:set var="TYPE" value="${book.booking_type}"/>
	<c:set var="DTAE" value="${book.booking_date}"/>	
	<c:set var="V_ID" value="${book.vacant_id_number}"/>
	
	<h4>Booking ID : </h4> ${book.id}
	<h4>Name : </h4> ${book.name}
	<h4>Nic number : </h4> ${book.nic}
	<h4>Booking Type : </h4> ${book.booking_type}
	<h4>Booking Date : </h4> ${book.booking_date}
	<h4>Vacant id : </h4> ${book.vacant_id_number}
	</c:forEach>
	
	<c:url value="update_booking.jsp" var="bookupdate">
		<c:param name="id" value="${ID}"/>
		<c:param name="name" value="${NAME}"/>
		<c:param name="nic" value="${NIC}"/>
		<c:param name="type" value="${TYPE}"/>
		<c:param name="date" value="${DTAE}"/>
		<c:param name="vid" value="${V_ID}"/>
	</c:url>
	<c:url value="delete_booking.jsp" var="bookdelete">
		<c:param name="id" value="${ID}"/>
		<c:param name="name" value="${NAME}"/>
		<c:param name="nic" value="${NIC}"/>
		<c:param name="type" value="${TYPE}"/>
