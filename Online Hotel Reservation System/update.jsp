...
<body>
            ...
            <div class="navbar-nav ms-auto py-0 pe-4 border-end border-5 border-primary">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="blog.html" class="dropdown-item"> Vacancies </a>
                        <a href="detail.html" class="dropdown-item">view booking</a>
            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">Update User Profile </h1>
	...
	<form action="update" method="post">
		...
		<input type="text" class="form-control bg-light border-0" name="name" value="<%= name%>"><br><br>
		<label for="password">Password</label><br>
		<input type="password" class="form-control bg-light border-0" name="password" value="<%= password%>"><br><br>
		<label for="phone">Phone</label><br>
		<input type="text"  class="form-control bg-light border-0" name="phone" value="<%= phone%>"><br><br>
		<label for="email">Email</label><br>
		<input type="email" class="form-control bg-light border-0" name="email" value="<%= email%>"><br><br>
