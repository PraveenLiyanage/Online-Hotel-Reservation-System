...
<form method="post" action="add_book">
		...
		<input type="text"  class="form-control bg-light border-0" name="nic"><br><br>
		
		<label for="phone">booking type</label><br>
		<input type="text"  class="form-control bg-light border-0" name="type"><br><br>
		
		<label for="phone">booking date</label><br>
		<input type="text"  class="form-control bg-light border-0" name="date"><br><br>
		
		 <label for="phone">vacant id number </label><br>
		<input type="text"  class="form-control bg-light border-0" name="idnumber"><br><br>
