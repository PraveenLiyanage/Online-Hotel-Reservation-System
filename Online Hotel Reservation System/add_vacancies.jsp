            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">add vacancies </h1>

<form method="post" action="add_vac">
		
		<label for="name">vacancies type</label><br>
		<input type="text"  class="form-control bg-light border-0" name="name"><br><br>
		
		<label for="password">price </label><br>
		<input type="text" class="form-control bg-light border-0" name="price"><br><br>
		
		<label for="phone"> available</label><br>
		<input type="text" class="form-control bg-light border-0" name="available"><br><br>
		
		<label for="phone"> Location</label><br>
		<input type="text" class="form-control bg-light border-0" name="location"><br><br>
		
		 
		 
		 
		
		<input type="submit" class="btn btn-primary w-100 py-3" value="submit">  
	</form>
 </div>
                </div>
            </div>
