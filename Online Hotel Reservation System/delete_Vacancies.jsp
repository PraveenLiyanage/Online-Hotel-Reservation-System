            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">delete vacancies </h1>
	<%
		String ID = request.getParameter("id");
		String TYPE = request.getParameter("typ");
		String PRICE = request.getParameter("pric");
		String AVAILABEL = request.getParameter("avail");
		String LOCATION = request.getParameter("locat");
		 
	%>
	
	<form action="delete_vacant" method="post">
		<label for="cid">vacancies ID</label><br>
		<input type="text" name="ID" class="form-control bg-light border-0"  value="<%= ID%>" readonly><br><br>
		<label for="name">vacancies type </label><br>
		<input type="text" name="name" class="form-control bg-light border-0"  value="<%= TYPE%>" readonly><br><br>
		<label for="password"> price  </label><br>
		<input type="text" name="price" class="form-control bg-light border-0"  value="<%= PRICE%>" readonly><br><br>
		<label for="phone">Availabale</label><br>
		<input type="text" name="available" class="form-control bg-light border-0"  value="<%= AVAILABEL%>" readonly><br><br>
		<label for="email">Location</label><br>
		<input type="text" name="location" class="form-control bg-light border-0"  value="<%= LOCATION%>" readonly><br><br>
		 
		
		<input type="submit" class="btn btn-primary w-100 py-3"  name="submit" value="DELETE">
  	</form> </div>
                </div>
            </div>
        </div>
