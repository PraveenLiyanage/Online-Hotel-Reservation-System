            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">search vacancies </h1>

<form action="search_vacant" method="post">

		<label for="name">VACANCIE ID</label><br>
		<input type="text" class="form-control bg-light border-0"  name="v_id"><br><br>
		<input type="submit" class="btn btn-primary w-100 py-3"  name="SEARCH">
	</form>
 </div>
                </div>
            </div>
