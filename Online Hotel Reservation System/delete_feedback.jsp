...
<body>
            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">delete feedback </h1>
	<%
	...
	<form action="delete_feed" method="post">
		...
		<input type="text" name="feed" class="form-control bg-light border-0"  value="<%= feed%>" readonly><br><br>
		<label for="password"> email  </label><br>
		<input type="text" name="email" class="form-control bg-light border-0"  value="<%= email%>" readonly><br><br>
