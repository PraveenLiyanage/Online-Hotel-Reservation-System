...
<form method="post" action="add_feed">
		...
		<input type="email"   class="form-control bg-light border-0" name="email"><br><br>
		
		<label for="phone">feedback</label><br>
		<input type="text"  class="form-control bg-light border-0" name="feedback"><br><br>
