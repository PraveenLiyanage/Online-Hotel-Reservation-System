...
<body>
            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">update vacancies </h1>
	...
	<form action="update_vacant" method="post">
		...
		<input type="text" name="name" class="form-control bg-light border-0"  value="<%= TYPE%>"><br><br>
		<label for="password"> price  </label><br>
		<input type="text" name="price" class="form-control bg-light border-0"  value="<%= PRICE%>"><br><br>
		<label for="phone">Availabale</label><br>
		<input type="text" name="available" class="form-control bg-light border-0"  value="<%= AVAILABEL%>"><br><br>
		<label for="email">Location</label><br>
		<input type="text" name="location" class="form-control bg-light border-0"  value="<%= LOCATION%>"><br><br>
