...
<body>
            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <div class="bg-white text-center p-5">
                        <h1 class="mb-4">Delete User Profile </h1>
	...
	<form action="deletea" method="post">
		...
		<input type="text" class="form-control bg-light border-0" name="cid" value="<%= id%>" readonly><br><br>
		<label for="name">Name</label><br>
		<input type="text" class="form-control bg-light border-0" name="name" value="<%= name%>" readonly><br><br>
		<label for="password">Password</label><br>
		<input type="password" class="form-control bg-light border-0" name="password" value="<%= password%>" readonly><br><br>
		<label for="phone">Phone</label><br>
		<input type="text"  class="form-control bg-light border-0" name="phone" value="<%= phone%>" readonly><br><br>
		<label for="email">Email</label><br>
		<input type="email" class="form-control bg-light border-0" name="email" value="<%= email%>" readonly><br><br>
