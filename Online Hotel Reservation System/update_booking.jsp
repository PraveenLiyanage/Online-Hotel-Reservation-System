...
<body>
	...
	<form action="booking_update" method="post">
		...
		<input type="text" name="NIC" class="form-control bg-light border-0"  value="<%= nic%>"><br><br>
		<label for="phone">Booking Type</label><br>
		<input type="text" name="TYPE" class="form-control bg-light border-0"  value="<%= type%>"><br><br>
		<label for="email">Booking Date</label><br>
		<input type="text" name="DATE" class="form-control bg-light border-0"  value="<%= date%>"><br><br>
		<label for="email">Vacancies ID</label><br>
		<input type="text" name="V_ID" class="form-control bg-light border-0"  value="<%= vid%>"><br><br>
